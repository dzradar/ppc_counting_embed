...
/****************************************************************************************
*Function name : adt3102DigiInit
*Description   : initial high clock, sleep config, rtc and calibration, reset phase shifter. 
*Paramater	   :
*        @ :    
*Paramater	selection:		
*Power consumption : 
...
/****************************************************************************************
*Function name : adt3102RfInit
*Description   : initial tx and rx and psr
*Paramater	   :
*        @rx0En :  rx0 enable
*        @rx1En :  rx1 enable
*        @tx0En :  tx0 enable
*        @tx1En :  tx1 enable
*        @phaseShftLut0 :   phase Shift Lut0
*        @phaseShftLut1 :   phase Shift Lut1
*        @chirpNumber :   
*        @ :   
*Paramater	selection:		
...
/****************************************************************************************
*Function name : adt3102Analog
*Description   : initial pa, lna, mixer, tia, pga, hpf, lpf and so on
*Paramater	   :
*        @ :  
*Paramater	selection:		
*Power consumption : 
